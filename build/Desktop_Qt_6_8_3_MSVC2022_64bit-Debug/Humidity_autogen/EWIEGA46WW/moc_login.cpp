...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->userIn((*reinterpret_cast< std::add_pointer_t<islogin>>(_a[1]))); break;
        case 1: _t->on_pushButton_clicked(); break;
        case 2: _t->islog(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Login::*)(const islogin & );
            if (_q_method_type _q_method = &Login::userIn; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Login::userIn(const islogin & _t1)
{
